...
func (r *jsiiProxy_Registration) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (r *jsiiProxy_Registration) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
