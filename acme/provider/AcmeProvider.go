...
import (
	...
	"github.com/cdktn-io/cdktn-provider-acme-go/acme/v15/provider/internal"
...
func (a *jsiiProxy_AcmeProvider) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (a *jsiiProxy_AcmeProvider) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
