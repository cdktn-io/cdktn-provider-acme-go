...
func (c *jsiiProxy_Certificate) MarkWriteOnlyAttribute(value interface{}) interface{} {
...
func (c *jsiiProxy_Certificate) RegisterProviderFeatureUsage(feature cdktn.ProviderFeature) {
...
func (c *jsiiProxy_Certificate) With(mixins ...constructs.IMixin) constructs.IConstruct {
	args := []interface{}{}
