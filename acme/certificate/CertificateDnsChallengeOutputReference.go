...
import (
	...
	"github.com/cdktn-io/cdktn-provider-acme-go/acme/v15/certificate/internal"
...
func (j *jsiiProxy_CertificateDnsChallengeOutputReference) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCertificateDnsChallengeOutputReference(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) CertificateDnsChallengeOutputReference {
	_init_.Initialize()
...
func NewCertificateDnsChallengeOutputReference_Override(c CertificateDnsChallengeOutputReference, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, complexObjectIndex *float64, complexObjectIsFromSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CertificateDnsChallengeOutputReference)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) GetBooleanAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) InterpolationAsList() cdktn.IResolvable {
	var returns cdktn.IResolvable
...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) InterpolationForAttribute(terraformAttribute *string) cdktn.IResolvable {
...
func (c *jsiiProxy_CertificateDnsChallengeOutputReference) Resolve(context cdktn.IResolveContext) interface{} {
