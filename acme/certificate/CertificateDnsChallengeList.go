...
func (j *jsiiProxy_CertificateDnsChallengeList) TerraformResource() cdktn.IInterpolatingParent {
...
func NewCertificateDnsChallengeList(terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) CertificateDnsChallengeList {
	_init_.Initialize()
...
func NewCertificateDnsChallengeList_Override(c CertificateDnsChallengeList, terraformResource cdktn.IInterpolatingParent, terraformAttribute *string, wrapsSet *bool) {
	_init_.Initialize()
...
func (j *jsiiProxy_CertificateDnsChallengeList)SetTerraformResource(val cdktn.IInterpolatingParent) {
...
func (c *jsiiProxy_CertificateDnsChallengeList) AllWithMapKey(mapKeyAttributeName *string) cdktn.DynamicListTerraformIterator {
...
func (c *jsiiProxy_CertificateDnsChallengeList) Resolve(context cdktn.IResolveContext) interface{} {
